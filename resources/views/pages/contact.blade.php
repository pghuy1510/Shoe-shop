				...
				<div class="col-md-4 contact-grid-agile-w3">
					...
					<div class="col-md-4 contact-grid-agile-w3">
						<div class="contact-grid-agile-w33">
							...
							<h4>Email</h4>
							<p><a href="mailto:info@example.com">phamhuy1510@gmail.com.com</a></p>
						</div>
					</div>
	   ...
	   <div class="agile-contact-grids">
				<div class="agile-contact-left">
						...
						<h4> Thông Tin Liên Hệ</h4>
							<div class="mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Điện Thoại </p><span>0971599019</span>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-envelope-o" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Mail </p><a href="mailto:info@example.com">phamhuy1510@gmail.com</a>
								</div>
								<div class="clearfix"> </div>
							</div>
							<div class="mail-agileits-w3layouts">
								<i class="fa fa-map-marker" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Địa Chỉ</p><span>Thành Phố Hải Dương</span>
								</div>
								<div class="clearfix"> </div>
							</div>
					...
					<div class="col-md-6 contact-form">
						<h4 class="white-w3ls">Hộp Thư <span>Đóng Góp</span></h4>
